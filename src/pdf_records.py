...
class Pdf_records(FPDF):
                    ...
                    # Cells
                        ...
                        if mean:
                            ...
                            if table['cells'] == 'alpha_numeric' and  alpha_num == True:
                                ...
                                alpha = sr.get_alpha_grade(numeric_grade=numeric, lang=lang)
    ...
    def body(self, subjects_semantic: dict, x: float, y: float, alpha_num: bool, lang: str):
    ...
    def header_features_setter(self, lang: str, header_rect: bool = True, header_badge: bool = True, header_title: bool = True, header_info: bool = True):
